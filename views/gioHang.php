                    ...
                    <div class="col-lg-12">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="pro-remove">
                                                <a href="<?= BASE_URL . '?act=xoa-san-pham-trong-gio-hang&id_san_pham=' . $sanPham['san_pham_id'] ?>"
                                                    onclick="return confirm('Xác nhận xóa sản phẩm khỏi giỏ hàng?')">
                        ...
                        <div class="cart-update-option d-block d-md-flex justify-content-between">
                            ...
                            <div class="cart-update">
                                <a href="<?= BASE_URL . '?act=san-pham' ?>" class="btn btn-sqr">Update Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
