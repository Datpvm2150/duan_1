    ...
    <div class="footer-top section-padding">
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget-item">
                        <div class="widget-title">
                            <div class="widget-logo">
                                <a href="index.html">
                                    <img src="assets/image/logo/logo.png" alt="brand logo" width="100px">
                                </a>
                            </div>
                        </div>
                        <div class="widget-body">
                            <p>UniMobi là website bán điện thoại chuyên nghiệp, đáp ứng nhu cầu của khách hàng, hỗ trợ doanh nghiệp quản lý và phát triển kinh doanh hiệu quả.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title">Liên hệ chúng tôi</h6>
                        <div class="widget-body">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title">Thông tin chi tiết</h6>
                        <div class="widget-body">
                            <ul class="info-list">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>© 2024 <b>UniMobi</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>Group 9</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
